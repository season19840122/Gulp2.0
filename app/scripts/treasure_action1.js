		...
		if(flag) {
			...
			$('.flash_pic').on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',function() {
				...
				for(var i = 0;i<arr.length;i++) {
					...
					var pic = arr[i].pic || optionObj.options.hostImg+'images/treasure/treasure_no.png';
					//是顺豆，用固定的配置图片
					if(goodsType == 6) pic = optionObj.options.hostImg+"images/treasure/treasureSD.png";
